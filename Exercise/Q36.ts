...
Defining a function that accepts a size and 
the text of a message that should be printed 
on the Shirt. 
...
/* 1. call the function with the size and the 
    message variables.
  */

let size: string = "medium";
let message: string = "TypeScrip Insights with Kamran"
