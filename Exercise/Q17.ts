...
/*
Shrinking Guest List: You just found out 
that your new dinner
...
• Remove guests from your list one at a 
time until only two 
...
• Remove the last two names from your list, so 
you have an empty list. Print your list to make
